...
(function($) {
    ...
    */
    function ImagesGridModal(opts) {
        ...
        this.IconHeart_like = 'img/love_nf_green.png';
        this.IconHeart_dislike = 'img/love_nf_yellow.png';
        this.IconComment = "img/comment_nf.png";
    }
    ...
    //Vinh code here
    ImagesGridModal.prototype.ShowImageDetails = function()
    {
        //alert("show details: " + this.getImage(this.imageIndex).src);
        var img = this.getImage(this.imageIndex).src;
        checklike_img2(img);
        countlike_img(img);
        countcomment_img(img);
    }
    ImagesGridModal.prototype.OnIconHeartLoad_like = function(like,dislike,img)
    {
        //alert(this.getImage(this.imageIndex).src);
        //like_img_process(localStorage.iduser,this.getImage(this.imageIndex).src);
        //Kiểm tra có like ko
        var icon_like = document.getElementById(like);
        var icon_dislike = document.getElementById(dislike);
        checklike_img(img,icon_like,icon_dislike);
        //alert(this.getImage(this.imageIndex).src);

    }
    ImagesGridModal.prototype.OnIconHeartClick_like = function(like,dislike,img)
    {
        //alert(this.getImage(this.imageIndex).src);
        like_img_process(localStorage.iduser,this.getImage(this.imageIndex).src);
        //checklike_img(img,icon_like,icon_dislike);
    ...
    ImagesGridModal.prototype.OnIconHeartClick_dislike = function(like,dislike,img)
    {
        //alert("DISLIKE");
        dislike_img_process(this.getImage(this.imageIndex).src);
        //checklike_img(img,icon_like,icon_dislike);
        // $("#"+(this.imageIndex).src+"_dislike").hide();
        // $("#"+(this.imageIndex).src+"_like").hide();
    }
    ImagesGridModal.prototype.OnIconCommentClick = function()
    {
        show_popup(this.getImage(this.imageIndex).src);
    }
    ImagesGridModal.prototype.close_popup = function()
    {
        close_popup();
    }
    ImagesGridModal.prototype.send_comment = function()
    {
        send_comment(this.getImage(this.imageIndex).src);
    }
    ...
    ImagesGridModal.prototype.renderIndicatorContainer = function() {
        ...
        this.$indicator.append(
            $('<div>', {
                class: 'modal-indicator-list'
            }).append(list)
        )
        this.$indicator.append(
            $('<div>', {
                class: 'modal-indicator-action',
                align: 'left',
            }).append(
                $('<img>', {
                    id: "like_img",
                    src: this.IconHeart_like,
                    alt: 'Icon Heart',
                    title: 'I Love U',
                    style:'width: 32px; height: 32px; margin-right: 10px; margin-left: 10px;',
                    on: {
                        click: function(event) {
                            this.OnIconHeartClick_like(this.getImage(this.imageIndex).src+'_like',this.getImage(this.imageIndex).src+'_dislike',this.getImage(this.imageIndex).src);
                        }.bind(this)
                    }
                }),
                $('<img>', {
                    id: "dislike_img",
                    src: this.IconHeart_dislike,
                    alt: 'Icon Heart',
                    title: 'I Love U',
                    style:'width: 32px; height: 32px; margin-right: 10px; margin-left: 10px;',
                    on: {
                        click: function(event) {
                            this.OnIconHeartClick_dislike(this.getImage(this.imageIndex).src+'_like',this.getImage(this.imageIndex).src+'_dislike',this.getImage(this.imageIndex).src);
                        }.bind(this)
                    }
                }),
                $('<div>', {
                ...
                $('<span>', {
                    id: "number_like",
                    style:'position: absolute;margin-left: -7px;bottom: 10px;color: #fff;',
                }),
                $('<img>', {
                    src: this.IconComment,
                    alt: 'Icon Comment',
                    title: 'I Hate U',
                    style:'width: 32px; height: 32px; margin-right: 10px; margin-left: 10px;',
                    on: {
                        click: function(event) {
                            this.OnIconCommentClick();
                        }.bind(this)
                    }
                }),
                $('<span>', {
