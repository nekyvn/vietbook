      ...
      $.ajax({
          ...
          success: function(data) {
                 ...
                 $.each(data, function(index, value) {
                   ...
                   {
                    console.log(localStorage.iduser.toLowerCase + " - " + iduser.toLowerCase);
